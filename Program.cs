...
builder.Services.AddDbContext<PaymentContext>(
    options => options.UseNpgsql(builder.Configuration.GetConnectionString("paymentDBTest"))
);

builder.Services.AddScoped<IPaymentEntityService, PaymentEntityService>(); 
